...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
          # 테스트에 있는것 한장씩을 , train 전부와 비교하며, dists[테스트,트레인]
          # predict_label 할때는 테스트에 대해서만 
            for j in range(num_train):
                ...
                # X[i,:] = [158. 112.  49. ...  21.  67. 110.]
                # self.X_train[0.:] = [ 59.  62.  63. ... 123.  92.  72.]
                # 차의 제곱근 합의 루트
    ...
    def predict_labels(self, dists, k=1):
        ...
        print(dists.shape)
        print(dists[0])
        print(np.argsort(dists[0])) # idx 가나옴
